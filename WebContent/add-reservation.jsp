<%@ page language="java" %>
    <%@ page import="dao.RoomDAO, model.Room, java.util.List" %>
        <% RoomDAO roomDao=new RoomDAO(); List<Room> availableRooms = roomDao.getAllRooms();%>
                    ...
                    <div class="main">
                        ...
                        <div class="form-box">
                            ...
                            <% String msg=request.getParameter("msg"); if("success".equals(msg)) { %>
                                    <div
                                        style="color: green; font-weight: bold; background-color: #d4edda; padding: 10px; border: 1px solid #c3e6cb; border-radius: 5px; margin-bottom: 15px;">
                                ...
                                <select name="room_id" required>
                                    ...
                                    <% for(Room room : availableRooms) {
                                        ...
                                        <option value="<%= room.getRoomId() %>">
                                            <%= room.getType() %> - Room #<%= room.getRoomId() %> ($<%= room.getPrice()
                                                        %>)
                                        </option>
                                        <% } } %>
                                </select>
